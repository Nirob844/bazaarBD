...
router.get('/search', auth(ENUM_USER_ROLE.ADMIN), UsersController.searchUsers);
router.get('/filter', auth(ENUM_USER_ROLE.ADMIN), UsersController.filterUsers);
...
router.patch('/:id/lock', auth(ENUM_USER_ROLE.ADMIN), UsersController.lockUser);
router.patch(
  '/:id/unlock',
  auth(ENUM_USER_ROLE.ADMIN),
